...
impl<'a> UniswapPoolSwap<'a> {
    pub fn swap(mut self) -> eyre::Result<UniswapPoolSwapResult<'a>> {
        ...
        while amount_remaining != I256::ZERO && sqrt_price_x96 != sqrt_price_limit_x96 {
            ...
            steps.push(UniswapPoolSwapStep { end_tick: next_tick, init, liquidity, d_t0, d_t1 });
        }
...
#[derive(Debug, Clone)]
pub struct UniswapPoolSwapResult<'a> {
    pub fee:           u32,
...
#[derive(Clone, Debug)]
pub struct UniswapPoolSwapStep {
    end_tick:  i32,
    init:      bool,
    liquidity: u128,
    d_t0:      u128,
