...
mod tests {
    ...
    use alloy::signers::{local::LocalSigner, Signer, SignerSync};
    ...
    const ANGSTROM_DOMAIN: Eip712Domain = eip712_domain!(
        name: "Angstrom",
        version: "v1",
        chain_id: 344567,
        verifying_contract: TESTNET_ANGSTROM_ADDRESS,
    ...
    fn test_this() {
        ...
        let order = ExactFlashOrder {
            ...
            use_internal:         false,
            asset_in:             address!("0xd550015f84142abecd5e82c8f296083df3c9a80d"),
        ...
        let js_sig = bytes!("0x853c1c30956b8cb46936166216f139cd84cba88a14988f49eb8760c84f5b8d47018c3cefb0ef946cfcaea17bc3cc35d7bcc268b6b390240509fe09262170cac71c");
