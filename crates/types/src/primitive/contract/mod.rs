...
//         address, bytes, keccak256, normalize_v, Bytes, PrimitiveSignature,
// U256     };
...
//             min_price:            U256::from(27323588895604416_u128),
//             use_internal:         false,
//             asset_in:
// address!("0xd550015f84142abecd5e82c8f296083df3c9a80d"),             
// asset_out:            address!("0x3d85e7b30be9fd7a4bad709d6ed2d130579f9a2e"),
//             recipient:
// address!("0xa7f1aeb6e43443c683865fdb9e15dd01386c955b"),             
// hook_data:            Default::default(),             valid_for_block:
// 21792418,             meta:                 Default::default()
//         };

//         println!("Angstrom Domain Struct Encode Type: {}",
// ANGSTROM_DOMAIN.encode_type());
...
//         // real -
// 0x853c1c30956b8cb46936166216f139cd84cba88a14988f49eb8760c84f5b8d47018c3cefb0ef946cfcaea17bc3cc35d7bcc268b6b390240509fe09262170cac71c
//         // play -
// 0x4355c47d63924e8a72e509b65029052eb6c299d53a04e167c5775fd466751c9d07299936d304c153f6443dfa05f40ff007d72911b6f72307f996231605b915621c
//         let js_sig =
// bytes!("0x853c1c30956b8cb46936166216f139cd84cba88a14988f49eb8760c84f5b8d47018c3cefb0ef946cfcaea17bc3cc35d7bcc268b6b390240509fe09262170cac71c"
// );         let js_hash = keccak256(&js_sig);
//         println!("-------JS-------\n");
//         println!("Hash: {js_hash:?}\nSig: {js_sig:?}\n\n");
//         println!("LEN: {:?}", (**js_sig).len());
//         let pade_decoded_sig: Bytes = PrimitiveSignature::pade_decode(&mut
// &**js_sig, None)             .unwrap()
//             .pade_encode()
//             .into();

//         let bytes_decoded_sig =
// PrimitiveSignature::try_from(&**js_sig).unwrap();
