...
```*/
    ...
    ///Container for all the [`ERC721Holder`](self) function calls.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum ERC721HolderCalls {
        #[allow(missing_docs)]
        onERC721Received(onERC721ReceivedCall),
    }
    #[automatically_derived]
    impl ERC721HolderCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ERC721HolderCalls {
        const NAME: &'static str = "ERC721HolderCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<ERC721HolderCalls>] = &[
                {
                    fn onERC721Received(
                        data: &[u8],
                        validate: bool,
                        ...
                        <onERC721ReceivedCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC721HolderCalls::onERC721Received)
                    }
                    onERC721Received
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`ERC721Holder`](self) contract instance.

See the [wrapper's documentation](`ERC721HolderInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> ERC721HolderInstance<T, P, N> {
        ERC721HolderInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ERC721HolderInstance<T, P, N>>,
    > {
        ERC721HolderInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        ERC721HolderInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`ERC721Holder`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ERC721Holder`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ERC721HolderInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for ERC721HolderInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ERC721HolderInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ERC721HolderInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> ERC721HolderInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ERC721HolderInstance<T, P, N> {
            ERC721HolderInstance {
