...
```*/
    ...
    ///Container for all the [`IERC6909Claims`](self) events.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum IERC6909ClaimsEvents {
        #[allow(missing_docs)]
        Approval(Approval),
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IERC6909ClaimsEvents {
        const NAME: &'static str = "IERC6909ClaimsEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IERC6909ClaimsEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::Approval(inner) => {
