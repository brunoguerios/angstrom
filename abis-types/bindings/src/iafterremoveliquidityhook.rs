...
interface IAfterRemoveLiquidityHook {
    ...
    function afterRemoveLiquidity(address sender, PoolKey memory key, IPoolManager.ModifyLiquidityParams memory params, BalanceDelta delta, bytes memory hookData) external returns (bytes4, BalanceDelta);
}
```
...
pub mod IAfterRemoveLiquidityHook {
    use super::*;
    use alloy::sol_types as alloy_sol_types;
...
```*/
    ...
    ///Container for all the [`IAfterRemoveLiquidityHook`](self) function calls.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum IAfterRemoveLiquidityHookCalls {
        #[allow(missing_docs)]
        afterRemoveLiquidity(afterRemoveLiquidityCall),
    }
    #[automatically_derived]
    impl IAfterRemoveLiquidityHookCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[141u8, 178u8, 182u8, 82u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IAfterRemoveLiquidityHookCalls {
        const NAME: &'static str = "IAfterRemoveLiquidityHookCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IAfterRemoveLiquidityHookCalls>] = &[
                {
                    fn afterRemoveLiquidity(
                        ...
                        <afterRemoveLiquidityCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IAfterRemoveLiquidityHookCalls::afterRemoveLiquidity)
                    }
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`IAfterRemoveLiquidityHook`](self) contract instance.

See the [wrapper's documentation](`IAfterRemoveLiquidityHookInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> IAfterRemoveLiquidityHookInstance<T, P, N> {
        IAfterRemoveLiquidityHookInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IAfterRemoveLiquidityHookInstance<T, P, N>>,
    > {
        IAfterRemoveLiquidityHookInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IAfterRemoveLiquidityHookInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IAfterRemoveLiquidityHook`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IAfterRemoveLiquidityHook`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IAfterRemoveLiquidityHookInstance<
        T,
        P,
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IAfterRemoveLiquidityHookInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IAfterRemoveLiquidityHookInstance")
                .field(&self.address)
                .finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IAfterRemoveLiquidityHookInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IAfterRemoveLiquidityHookInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IAfterRemoveLiquidityHookInstance<T, P, N> {
            IAfterRemoveLiquidityHookInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
