...
impl Erc20ToDeploy {
    ...
    // pub async fn deploy_token0(
    //     &self,
    //     provider: &WalletProvider,
    //     nonce: &mut u64,
    //     addresses_with_hacked_balance: Option<&[Address]>,
    // ) -> eyre::Result<Address> {
    //     let (pending_tx, mut token_address) =
    ...
    //     let token_instance = MintableMockERC20::new(token_address,
    // provider.rpc_provider());     token_instance
    ...
    //         provider
    //             .override_address(&mut token_address, overwrite_addr)
    //             .await?;
    //     }
